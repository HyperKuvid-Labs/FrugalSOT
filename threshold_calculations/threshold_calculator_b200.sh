...
echo "threshold calculator for B200..."

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/.." && pwd)"
cd "$PROJECT_ROOT"

CONFIG_FILE="data/config_b200.json"
THRESHOLD_FILE="data/threshold_b200.json"
...
run_model_for_prompt() {
    ...
    export THRESHOLD_FILE="threshold_b200.json"
