...
echo "threshold calculator for H100..."

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/.." && pwd)"
cd "$PROJECT_ROOT"

CONFIG_FILE="data/config_h100.json"
THRESHOLD_FILE="data/threshold_h100.json"
...
run_model_for_prompt() {
    ...
    export THRESHOLD_FILE="threshold_h100.json"
