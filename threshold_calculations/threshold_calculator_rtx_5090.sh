...
echo "threshold calculator for RTX 5090..."

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/.." && pwd)"
cd "$PROJECT_ROOT"

CONFIG_FILE="data/config_rtx_5090.json"
THRESHOLD_FILE="data/threshold_rtx_5090.json"
...
echo "RTX 5090 GPU Configuration:"
...
run_model_for_prompt() {
    ...
    export THRESHOLD_FILE="threshold_rtx_5090.json"
